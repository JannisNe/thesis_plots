...
def dump_datafile(quantity, energyType, expName, subExpName, filename, combo_level=0, cache=None):
    ...
    write_data_to_file(cache.cache_dir / filename, header, data_lines)
...
def main(cache):
    experiments = [
        ...
        ('AllParticles', 'ETOT', 'IceCube', 'IceCube+IceTop (2010/06-2013/05) SIBYLL2.1', 'ICECUBE+ICETOP_allParticles_energy.txt'),
