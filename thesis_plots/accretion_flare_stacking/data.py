...
def energy_pdf():
    ...
    # ratio
    data_hist_filled = data_hist.copy()
    data_hist_filled[(data_hist_filled == 0) & (mc_hist > 0)] = 1
    data_hist_filled_normed = data_hist_filled / data_hist_filled.sum(axis=0)
    ratio = mc_hist_normed / data_hist_filled_normed
